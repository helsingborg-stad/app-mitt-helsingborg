      ...
      if (message.search('Jag vill veta mer om Mitt Helsingborg') !== -1) {
        ...
        chat.addMessages([
          ...
          },
          {
            ...
            componentProps: {
              content:
                'Med Mitt Helsingborg kommunicerar du med staden och får tillgång till alla tjänster du behöver.',
              modifiers: ['automated'],
            },
          },
          {
      ...
      chat.addMessages([
        {
          ...
          componentProps: {
            content:
              'Eftersom det är första gången du loggar in behöver du ange ditt personnummer.',
            modifiers: ['automated'],
          },
        },
      ]);
...
const InputAction = props => <Button onClick={() => props.addMessages(props.messages)} color={'light'} rounded>
    <Icon name="message" />
