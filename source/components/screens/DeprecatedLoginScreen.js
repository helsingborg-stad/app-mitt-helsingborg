      ...
      <ScreenWrapper>
        {isLoading === false ? (
          <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
            ...
            <View style={styles.loginContainer} testID="ViewLogin">
              {user.personalNumber !== 'undefined' && user.personalNumber ? (
                <>
                  <TouchableOpacity
                    ...
                    underlayColor="#fff"
                  >
                    <Text style={styles.buttonText} accessible testID="LoginButton">
                      Logga in
                    </Text>
                  </TouchableOpacity>
                  <View style={styles.loginFooter} testID="ChangeLogInUser">
                    <Button
                      accessible
                ...
                <>
                  ...
                  <View style={styles.paper}>
                    ...
                    <TouchableOpacity
                      ...
                      disabled={!validPin}
                    >
                      <Text style={[styles.buttonText, !validPin ? styles.buttonTextDisabled : '']}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.loginContainer}>
              <TouchableOpacity style={styles.button} onPress={cancelLogin} underlayColor="#fff">
