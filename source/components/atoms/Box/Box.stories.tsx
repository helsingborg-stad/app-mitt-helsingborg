...
boxStories.add("Padding", () => (
  <StoryWrapper>
    ...
    <Box bg="#ececec" py="50px">
      <Text>
        Setting padding through the py (padding-top and padding-bottom) prop
      </Text>
    </Box>

    <Box bg="#ccc" px="50px">
      <Text>
        Setting padding through the px (padding-left and padding-right) prop
      </Text>
    </Box>
  </StoryWrapper>
));
...
boxStories.add("Margin", () => (
  <StoryWrapper>
    ...
    <Box bg="#ccc" my="50px">
      <Text>
        Setting margin through the my (margin-top and margin-bottom) prop
      </Text>
    </Box>

    <Box bg="#ccc" mx="50px">
      <Text>
        Setting margin through the mx (margin-left and margin-right) prop
      </Text>
    </Box>
  </StoryWrapper>
));
...
boxStories.add("Height and Width", () => (
  <StoryWrapper>
    ...
    <Box bg="aliceblue" height="250px" width="100%">
      <Text>
        This box is 250px in height and 100% of the parent container in width
      </Text>
    </Box>
  </StoryWrapper>
));
...
boxStories.add("Background", () => (
  <StoryWrapper>
    <Box bg="#ececec" height="100px" width="100%">
      <Text>
        This box has a background color of #ececec passed thorugh the bg prop
      </Text>
    </Box>

    <Box colorSchema="blue" height="100px" width="100%">
      <Text>
        This box has a blue background color that is retreived from the theme
        context by using the colorSchema prop. You can also use purple, red and
        green.
      </Text>
    </Box>
  </StoryWrapper>
