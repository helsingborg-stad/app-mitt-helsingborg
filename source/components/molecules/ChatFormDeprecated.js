...
const ChatFormDeprecated = props => {
  ...
  const children = props.children && props.children.length > 0 ? React.Children.map(props.children, (child, index) => (child && child.type ? React.createElement(child.type, {...child.props, ...props}) : child)) : false;
