    ...
    <PersonFieldContainer colorSchema={validColorSchema}>
      <PersonFieldHeader>
        ...
        <PersonFieldDetails>
          ...
          <PersonFieldInfoRelation>{`${relation}`}</PersonFieldInfoRelation>
          <PersonFieldInfoPNO>
        ...
        {inputs.map((input) => (
          ...
          >
            <PersonFieldInputLabelWrapper>
              <PersonFieldInputLabel>{input.label}</PersonFieldInputLabel>
            </PersonFieldInputLabelWrapper>
            <PersonFieldInputWrapper>
              <PersonFieldInput editable={isEditable} value={input.value} />
            </PersonFieldInputWrapper>
          </PersonFieldInputContainer>
        ))}
      </PersonFieldBody>
      {isEditable && (
        <PersonFieldFooter>
          <PersonFieldDeleteButton onPress={onDelete}>
            <Text>{`Ta Bort ${firstName}`.toUpperCase()}</Text>
