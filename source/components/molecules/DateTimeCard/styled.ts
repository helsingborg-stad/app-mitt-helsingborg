...
const TitleText = styled.Text<{ size: string; theme: ThemeType }>`
...
const DateText = styled.Text<{ size: string; theme: ThemeType }>`
  font-size: ${({ size, theme }) =>
...
const TimeText = styled.Text<{ size: string; theme: ThemeType }>`
  font-size: ${({ size, theme }) =>
