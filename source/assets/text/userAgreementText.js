/**
 * Text for user agreement.
 * This text is formatted with markdown.
 *
 * @type {string} Markdown formatted user agreement.
 */
const userAgreementText = `
**Behandling av personuppgifter**
I texten nedan finns information om hur Helsingborgs stad (nedan Staden) behandlar dina personuppgifter när du använder appen Mitt Helsingborg.



I appen Mitt Helsingborg får du tillgång till tjänster och information från kommunen, du kan följa dina ärenden, få personlig service och få svar på frågor om tjänsterna i appen. Appen innehåller också e-tjänster. Detaljerad information om den personuppgiftsbehandling som sker i respektive e-tjänst och vilken nämnd inom Staden som ansvarar för behandlingen finner du under rubriken ”Behandling av personuppgifter i e-tjänsten” när du startar respektive tjänst.



**Varifrån får vi de personuppgifter som behandlas om dig när du använder appen?**
För att använda appen Mitt Helsingborg måste du ha en e-legitimation, mobilt bank-ID. På webbplatsen e-legitimation.se kan du läsa mer om e-legitimation och hur du skaffar den.



När du loggar in i appen första gången hämtar vi personlig information om dig, så som namn, personnummer och adress från Skatteverket och ber dig att bekräfta att denna information är korrekt. Om uppgifterna inte stämmer måste du ta kontakt med Skatteverket. Vill du komplettera med ytterligare information, så som e-postadress eller telefonnummer, gör du det genom att fylla i din personliga profil i appen. Den information som vi hämtar från Skatteverket tillsammans med de uppgifter du själv lämnar i appen kommer att föreslås i de e-tjänster som du använder i appen, för att underlätta din användning av våra tjänster.
...
Utöver den personliga information som anges ovan kan vi komma att automatiskt samla in och behandla följande information när du använder appen:
  ...
  + Information om tjänsterna som du använt hos oss, tidsåtgång, vilka etjänster och funktioner du har använt.
